...
var labels = jsonfile.Global.map(function(e) {
    return e.name;
});
var total = jsonfile.Global.map(function(e) {
    return e.tot;
});
var death = jsonfile.Global.map(function(e) {
    return e.death;
});

var cured = jsonfile.Global.map(function(e) {
    return e.cured;
});
